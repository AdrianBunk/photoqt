...
void on_vlc_events(void *vlc) {
    Q_UNUSED(vlc)
}

void on_vlc_redraw(void *vlc) {
    PQVLCObject::on_update(vlc);
}

static void *get_proc_address_vlc(void *vlc, const char *name) {
...
class PQVLCRenderer : public QQuickFramebufferObject::Renderer {

    PQVLCObject *obj;

public:
    PQVLCRenderer(PQVLCObject *new_obj) : obj{new_obj} {}
